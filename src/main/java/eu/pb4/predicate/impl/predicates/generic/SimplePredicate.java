...
public final class SimplePredicate extends AbstractPredicate {
    public static final MinecraftPredicate HAS_PLAYER = new SimplePredicate(Identifier.method_60656("has_player"), PredicateContext::hasPlayer);
    public static final MinecraftPredicate HAS_ENTITY = new SimplePredicate(Identifier.method_60656("has_entity"), PredicateContext::hasEntity);
    public static final MinecraftPredicate HAS_WORLD = new SimplePredicate(Identifier.method_60656("has_world"), PredicateContext::hasWorld);
    public static final MinecraftPredicate HAS_GAME_PROFILE = new SimplePredicate(Identifier.method_60656("has_game_profile"), PredicateContext::hasGameProfile);
